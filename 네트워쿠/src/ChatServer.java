		...
		public void run() {
			...
			try {// client status 0: 방금서버에 입장/ 1:방장 /2 :방찾는중/
				...
				while ((inputLine = in.readLine()) != null) {
					...
					// if()
					/*
					 * switch(clientStatus ) { case 1: //out.println(
					 * "다른 유저의 접속을 기다리는 중입니다....."); //
					 * if(rooms[roomSeq].getPlayers() ==2){
					 * 
					 * // }
					 * 
					 * 
					 ...
					 * break;
					 * 
					 * case 2: // TODO: 방의 번호를 받아서 이 클라이언트를 구성원으로 넣는 ChatServer의
					 * //메서드를 만들어서 호출해!!!!! break;
					 * 
					 * default: out.println(
					 * "ERROR!! Wrong command. please retry."); break; }
					 */
